...
function doTooltip(evt,num) {
	...
	if (ns4) {
		...
		var tip = startStr + messages[num][0] + midStr + '<span style="text-align:center;font-family:' + tipFontFamily + '; font-size:' + tipFontSize + '; color:' + curFontColor + ';">' + messages[num][1] + '</span>' + endStr;
